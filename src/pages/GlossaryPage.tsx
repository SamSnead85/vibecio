...
const glossaryTerms: GlossaryTerm[] = [
    { term: 'Agentic AI', definition: 'AI systems capable of autonomous decision-making and action-taking to achieve specified goals with minimal human intervention.', category: 'AI', related: ['LLM', 'GenAI'] },
